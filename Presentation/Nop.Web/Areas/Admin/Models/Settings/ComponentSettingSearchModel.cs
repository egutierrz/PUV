...
namespace Nop.Web.Areas.Admin.Models.Settings
{
    ...
    /// </summary>
    public partial record ComponentSettingSearchModel : BaseSearchModel
    {
        #region Ctor

        public ComponentSettingSearchModel()
        {
            AddSetting = new ComponentSettingModel();
        }
        ...
        public ComponentSettingModel AddSetting { get; set; }
