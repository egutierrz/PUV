...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    /// </summary>
    public partial interface IComponentSettingModelFactory
    {
        /// <summary>
        ...
        /// </returns>
        Task<ComponentSettingSearchModel> PrepareSettingSearchModelAsync(ComponentSettingSearchModel searchModel);
        ...
        /// </returns>
        Task<ComponentSettingListModel> PrepareSettingListModelAsync(ComponentSettingSearchModel searchModel);
        ...
        /// </returns>
        Task<ComponentSettingModeModel> PrepareSettingModeModelAsync(string modeName);
