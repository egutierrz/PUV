...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    /// </summary>
    public partial class ComponentSettingModelFactory : IComponentSettingModelFactory
    {
        #region Fields
        ...
        public ComponentSettingModelFactory(AppSettings appSettings,
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        protected virtual async Task PrepareAddSettingModelAsync(ComponentSettingModel model)
        {
            if (model == null)
        ...
        /// </returns>
        public virtual async Task<ComponentSettingSearchModel> PrepareSettingSearchModelAsync(ComponentSettingSearchModel searchModel)
        {
            if (searchModel == null)
                throw new ArgumentNullException(nameof(searchModel));
        ...
        /// </returns>
        public virtual async Task<ComponentSettingListModel> PrepareSettingListModelAsync(ComponentSettingSearchModel searchModel)
        {
            if (searchModel == null)
                throw new ArgumentNullException(nameof(searchModel));
            ...
            //prepare list model
            var model = await new ComponentSettingListModel().PrepareToGridAsync(searchModel, pagedSettings, () =>
            {
                return pagedSettings.SelectAwait(async setting =>
                {
                    //fill in model values from the entity
                    var settingModel = new ComponentSettingModel();
                    settingModel.Id = setting.Id;
                    settingModel.Value = setting.Value;
                    settingModel.Name = setting.Name;
        ...
        /// </returns>
        public virtual async Task<ComponentSettingModeModel> PrepareSettingModeModelAsync(string modeName)
        {
            var model = new ComponentSettingModeModel
            {
                ModeName = modeName,
