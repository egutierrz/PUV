namespace Nop.Core.Domain.Customers
{
    ...
    public static partial class NopCustomerDefaults
    {
        ...
        public static string AdministratorsRoleName => "Administrador";

        /// <summary>
        /// Gets a system name of 'registered' customer role
        /// </summary>
        public static string AccessRoleName => "Acceso";

        public static string UserRoleName => "Usuario";

        /// <summary>
        /// Gets a system name of 'guests' customer role
        /// </summary>
        public static string BackgroundRoleName => "Background";

        /// <summary>
        /// Gets a system name of 'vendors' customer role
        /// </summary>
        public static string MonitoreoRoleName => "Monitoreo SAT";
        
        /// <summary>
        /// Gets a system name of 'vendors' customer role
        /// </summary>
        public static string ApiRoleName => "API Client";

        public static string ReaderRoleName => "Lector";

        public static string AuthorRoleName => "Autor";

        public static string ApproverRoleName => "Aprobador";
