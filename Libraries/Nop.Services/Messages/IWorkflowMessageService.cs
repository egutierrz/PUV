...
namespace Nop.Services.Messages
{
    ...
    public partial interface IWorkflowMessageService
    {
        ...
        /// The task result contains the queued email identifier
        /// </returns>
        Task<IList<int>> SendCustomerNotificationByChangesInFollowedFile(Customer customer, Customer modifier, SatRepositoryInfoFiles file, string messageTemplateName, int languageId);
