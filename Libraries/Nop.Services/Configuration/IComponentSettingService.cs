...
namespace Nop.Services.Configuration
{
    ...
    /// </summary>
    public partial interface IComponentSettingService
    {
        /// <summary>
        ...
        /// </returns>
        Task<ComponentSetting> GetSettingByIdAsync(int settingId);
        ...
        Task DeleteSettingAsync(ComponentSetting setting);
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        Task DeleteSettingsAsync(IList<ComponentSetting> settings);
        ...
        /// The task result contains the setting
        /// </returns>
        Task<ComponentSetting> GetSettingAsync(string key, int storeId = 0, bool loadSharedValueIfNotFound = false);
        ...
        /// </returns>
        Task<IList<ComponentSetting>> GetAllSettingsAsync();
