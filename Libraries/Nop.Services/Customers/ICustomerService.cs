...
namespace Nop.Services.Customers
{
    ...
    public partial interface ICustomerService
    {
        ...
        /// The task result contains the customer
        /// </returns>
        Task<Customer> InsertBackgroundCustomerAsync();
        ...
        /// </returns>
        Task<int> DeleteBackgroundCustomersAsync(DateTime? createdFromUtc, DateTime? createdToUtc, bool onlyWithoutShoppingCart);
        ...
        /// The task result contains the result
        /// </returns>
        Task<bool> IsBackgroundAsync(Customer customer, bool onlyActiveCustomerRoles = true);
        ...
        /// The task result contains the result
        /// </returns>
        Task<bool> IsAuthorAsync(Customer customer, bool onlyActiveCustomerRoles = true);
        ...
        /// The task result contains the result
        /// </returns>
        Task<bool> IsAuthorizerAsync(Customer customer, bool onlyActiveCustomerRoles = true);
        ...
        /// The task result contains the result
        /// </returns>
        Task<bool> IsReaderAsync(Customer customer, bool onlyActiveCustomerRoles = true);
