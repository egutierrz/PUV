    ...
    public partial class CustomerService : ICustomerService
    {
        ...
        public virtual async Task<Customer> GetOrCreateBackgroundTaskUserAsync()
        {
            ...
            if (backgroundTaskUser is null)
            {
                ...
                var guestRole = await GetCustomerRoleBySystemNameAsync(NopCustomerDefaults.BackgroundRoleName);
        ...
        /// The task result contains the customer
        /// </returns>
        public virtual async Task<Customer> InsertBackgroundCustomerAsync()
        {
        ...
        /// </returns>
        public virtual async Task<int> DeleteBackgroundCustomersAsync(DateTime? createdFromUtc, DateTime? createdToUtc, bool onlyWithoutShoppingCart)
        {
            var guestRole = await GetCustomerRoleBySystemNameAsync(NopCustomerDefaults.BackgroundRoleName);
            ...
            var eliminar = allGuestCustomers.ToList();

            //EGG Generar código
            await _customerRepository.DeleteAsync(eliminar, false, true);
        ...
        public virtual async Task<string> FormatUsernameAsync(Customer customer, bool stripTooLong = false, int maxLength = 0)
        {
            ...
            if (await IsBackgroundAsync(customer))
        ...
        {
            return await IsInCustomerRoleAsync(customer, NopCustomerDefaults.SuperAdminRoleName, onlyActiveCustomerRoles);
        }
        ...
        {
            return await IsInCustomerRoleAsync(customer, NopCustomerDefaults.AccessRoleName, onlyActiveCustomerRoles);
        }
        ...
        /// The task result contains the result
        /// </returns>
        public virtual async Task<bool> IsBackgroundAsync(Customer customer, bool onlyActiveCustomerRoles = true)
        {
            return await IsInCustomerRoleAsync(customer, NopCustomerDefaults.BackgroundRoleName, onlyActiveCustomerRoles);
        }
        ...
        {
            return await IsInCustomerRoleAsync(customer, NopCustomerDefaults.MonitoreoRoleName, onlyActiveCustomerRoles);
        }

        /// <summary>
        /// Gets a value indicating whether customer is author
        /// </summary>
        /// <param name="customer">Customer</param>
        /// <param name="onlyActiveCustomerRoles">A value indicating whether we should look only in active customer roles</param>
        /// <returns>
        ...
        /// The task result contains the result
        /// </returns>
        public virtual async Task<bool> IsAuthorAsync(Customer customer, bool onlyActiveCustomerRoles = true)
        {
            return await IsInCustomerRoleAsync(customer, NopCustomerDefaults.AuthorRoleName, onlyActiveCustomerRoles);
        }

        /// <summary>
        /// Gets a value indicating whether customer is authorizer
        /// </summary>
        /// <param name="customer">Customer</param>
        /// <param name="onlyActiveCustomerRoles">A value indicating whether we should look only in active customer roles</param>
        /// <returns>
        ...
        /// The task result contains the result
        /// </returns>
        public virtual async Task<bool> IsAuthorizerAsync(Customer customer, bool onlyActiveCustomerRoles = true)
        {
            return await IsInCustomerRoleAsync(customer, NopCustomerDefaults.ApproverRoleName, onlyActiveCustomerRoles);
        }

        /// <summary>
        /// Gets a value indicating whether customer is reader
        /// </summary>
        /// <param name="customer">Customer</param>
        /// <param name="onlyActiveCustomerRoles">A value indicating whether we should look only in active customer roles</param>
        /// <returns>
        ...
        /// The task result contains the result
        /// </returns>
        public virtual async Task<bool> IsReaderAsync(Customer customer, bool onlyActiveCustomerRoles = true)
        {
            return await IsInCustomerRoleAsync(customer, NopCustomerDefaults.ReaderRoleName, onlyActiveCustomerRoles);
        }
